...
func TestExecuteGuestsListReturnsPermissionDeniedForAttendee(t *testing.T) {
	...
	const want = `{"ok":false,"error":{"type":"permission.denied","code":"HOST_PERMISSION_REQUIRED","message":"This command requires host access to the event.","retryable":false,"details":{"requiredRole":"host"}},"meta":{"command":"guests.list","cliVersion":"3.0.1","productContractRevision":"2026-08-12.7","remoteContractRevision":"2026-08-12.7"}}` + "\n"
...
func TestExecuteGuestsListReturnsEmptyCollectionForHost(t *testing.T) {
	...
	const want = `{"ok":true,"data":{"items":[]},"meta":{"command":"guests.list","cliVersion":"3.0.1","productContractRevision":"2026-08-12.7","remoteContractRevision":"2026-08-12.7","warnings":[],"page":{"limit":25,"nextCursor":null,"hasMore":false}}}` + "\n"
...
func TestExecuteGuestsInviteDryRunsAndDispatchesResolvedContact(t *testing.T) {
	...
	const want = `{"ok":true,"data":{"eventId":"event-example","submitted":true},"meta":{"command":"guests.invite","cliVersion":"3.0.1","productContractRevision":"2026-08-12.7","remoteContractRevision":"2026-08-12.7","warnings":[]}}` + "\n"
